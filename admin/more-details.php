  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
		...
		<a type="button"  class="btn btn-inline btn-info" href="<?=URLAD?>list-product"><i class="fa fa-arrow-left"></i> Back</a>
		</div>
		</div>
		<div class="row">
			<div class="col-md-12">
		  ...
		  <div class="row">
				...
				<div class="col-md-4">
					<div class="form-group">
											...
											<div>
												...
												{
												?>
												<a href="<?=$add_url?>/?id=<?php echo $detail;?>&page=<?=$page?>&st1=<?php echo $best_seller; ?>" role="button" class="btn btn-success btn-sm" ><?=$best_seller?></a>
												<?php
												}
												else
												{
												?>
												<a href="<?=$add_url?>/?id=<?php echo $detail;?>&page=<?=$page?>&st1=<?php echo $best_seller; ?>" role="button" class="btn btn-danger btn-sm" ><?=$best_seller?></a>
												<?php
												}
												?>
													</div>
		   ...
		   <br clear="all"   />           
                                    <div class="clearfix form-actions" align="center" style="background-color:#E5E5E5;padding:20px">
