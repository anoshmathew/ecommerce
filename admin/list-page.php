...
if($_GET['msg']==2)
{
  $msg2 	= "Pages Updated Successfully.";
}

if($_GET['msg']==3)
{
  $msg2 	= "Pages  Deleted Successfully."; 
}
...
if(isset($_GET['del']))
{
    ...
    $photo    = $objgen->check_tag($result['image']);
     ...
     $msg 	  = $objgen->del_Row("page_img","page_id=".$id);
		
	$msg 	  = $objgen->del_Row("pages","id=".$id);
...
$row_count = $objgen->get_AllRowscnt("pages",$where);
if($row_count>0)
{
  ...
  $res_arr = $objgen->get_AllRows("pages",$pagesize*($page-1),$pagesize,"id desc",$where);
}
      ...
      <div class="col-md-12">
        <div class="card ">
          ...
          <div class="card-body table-responsive p-0">
            ...
            <td><?php echo $objgen->check_tag($val['page']); ?></td>
