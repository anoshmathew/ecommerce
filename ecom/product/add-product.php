          ...
          <form role="form" method="post" enctype="multipart/form-data" >
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?=$product_name?>" name="product_name" id="product_name"  required />
                  </div>
                </div>
				<div class="col-md-4">
                  <div class="form-group">
                    <label for="category_name">Create Date <span class="error" style="color:red;">*</span></label>
                    <input type="text" class="form-control date" value="<?=$create_date?>" name="create_date" id="create_date" required />
                  </div>
                </div>
				<div class="col-md-4">
                  <div class="form-group">
                    <label for="category_name">Model No <span class="error" style="color:red;">*</span></label>
                    <input type="text" class="form-control" value="<?=$model_no?>" name="model_no" id="model_no" required />
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="brand">Brand Name <span class="error" style="color:red;">*</span></label>
                    <input type="text" class="form-control" value="<?=$brand?>" name="brand" id="brand"  required />
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select name="category" id="category" required class="form-control selectpicker" data-live-search="true" onChange="product_cat(this.value)">
                      ...
                      <?php
             			if($cat_count>0)
             			{
                			...
                			{
                    			 ?>
                      			<option value="<?=$val['id']?>" <?php if($val['id']==$category) { ?> selected="selected" <?php } ?> >
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select class="form-control selectpicker" name="status" id="status" required>
                      <option value="Not sold" <?php if($status=='Not sold') { ?> selected="selected" <?php } ?> >Not sold</option>
                      <option value="Sold" <?php if($status=='Sold') { ?> selected="selected" <?php } ?> >Sold</option>
                    </select>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    <label for="category_name">Our Percent </label>
                    <select class="form-control selectpicker" name="price_percentage" id="price_percentage" onChange="chng_price()" data-live-search="true" >
                      <?php
															...
															?>
                      <option value="<?php echo $i;?>" <?php if($i == $price_percentage) { ?> selected="selected" <?php } ?>><?php echo $i;?>%</option>
                      <?php
															}
															?>
                    </select>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?=$actual_price?>" name="actual_price" id="actual_price"  required />
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    <label for="our_price">Selling Price</label>
                    <input type="text" class="form-control" value="<?=$our_price?>" name="our_price" id="our_price"   />
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    <label for="category_name">Quantity <span class="error" style="color:red;">*</span></label>
                    <input type="text" class="form-control" value="<?=$quantity?>" name="quantity" id="quantity" required />
                  </div>
                </div>
                <div  class="col-md-3">
                  <div class="form-group">
                    ...
                    <div class="icheck-primary d-inline">
                      <input  type="radio" value="active" <?php if($p_status=='active') { ?> checked="checked"  <?php } ?> name="p_status" id="radioPrimary1" >
                      <label for="radioPrimary1">Active </label>
                    </div>
                    &nbsp&nbsp
                    <div class="icheck-primary d-inline">
                      <input   type="radio" value="inactive" <?php if($p_status=='inactive') { ?> checked="checked"  <?php } ?> name="p_status" id="radioPrimary2" >
                ...
                <div  class="col-md-3">
                  <div class="form-group">
                    ...
                    <br />
                    <div class="icheck-primary d-inline">
                      <input  type="radio" value="yes" <?php if($best_seller=='yes') { ?> checked="checked"  <?php } ?> name="best_seller" id="radioPrimary3" >
                      <label for="radioPrimary3">Yes </label>
                    </div>
                    &nbsp&nbsp
                    <div class="icheck-primary d-inline">
                      <input type="radio" value="no" <?php if($best_seller=='no') { ?> checked="checked"  <?php } ?> name="best_seller" id="radioPrimary4" >
                ...
                <div  class="col-md-3">
                  <div class="form-group">
                    ...
                    <br />
                    <div class="icheck-primary d-inline">
                      <input type="radio" value="yes" <?php if($featured=='yes') { ?> checked="checked"  <?php } ?> name="featured" id="radioPrimary5" >
                      <label for="radioPrimary5">Yes </label>
                    </div>
                    &nbsp&nbsp
                    <div class="icheck-primary d-inline">
                      <input type="radio" value="no" <?php if($featured=='no') { ?> checked="checked"  <?php } ?> name="featured" id="radioPrimary6" >
				...
				<div  class="col-md-3">
                  <div class="form-group">
                    ...
                    <br />
                    <div class="icheck-primary d-inline">
                      <input type="radio" value="used" <?php if($used=='used') { ?> checked="checked"  <?php } ?> name="used" id="radioPrimary7" >
                      <label for="radioPrimary7">Yes </label>
                    </div>
                    &nbsp&nbsp&nbsp&nbsp
                    <div class="icheck-primary d-inline">
                      <input type="radio" value="notused" <?php if($used=='notused') { ?> checked="checked"  <?php } ?> name="used" id="radioPrimary8" >
                    ...
                    <select name="country" id="country" class="form-control selectpicker" data-live-search="true" required>
                      ...
                      <?php
                                  ...
                                  if($ctry_cnt>0)
                                  {
                                      ...
                                      {
                                   ?>
                      <option value="<?=$val['id']?>" <?php if($val['id']==$country) { ?> selected="selected" <?php } ?> >
                    ...
                    <select name="tax" id="tax" class="form-control selectpicker" data-live-search="true" >
                      ...
                      <?php
             				if($tax_count>0)
             				{
                				...
                				{
                          			 ?>
                      <option value="<?=$val['id']?>" <?php if($val['id']==$tax) { ?> selected="selected" <?php } ?> >
                      <?=$objgen->check_tag($val['name'])?>
                      </option>
                      <?php
                             									 }
             												...
             												if($shipp_count>0)
             											 	{
                												...
                												{
                          											 ?>
                      <option value="<?=$val['id']?>" <?php if($val['id']==$shipp_id) { ?> selected="selected" <?php } ?> >
                      <?=$objgen->check_tag($val['name'])?>
                      </option>
                      <?php
                             									 }
                ...
                <div class="form-group" id='weight1' style="display:<?=$sr?>;">
                  ...
                  <input type="text" class="form-control" value="<?=$shipp_name?>" name="shipp_name" id="shipp_name"  />
                </div>
              </div>
              <div class="col-md-12">
                <div class="form-group" id='weight2' style="display:<?=$sr?>">
                  <label for="category_name">Shipping Amount</label>
                  <input type="text" class="form-control " value="<?=$shipp_amount?>" name="shipp_amount" id="shipp_amount" />
                </div>
              </div>
                </div>
                  ...
                  <select class="form-control" name="attribute[]" id="attribute" multiple="multiple" size="5">
                    <?php
                      	if($attribute_count>0)
                      	{
                      		...
                      		{
                      			?>
                    <option value="<?=$val['id']?>" <?php if($attribute==$val['id']) { ?>  <?php } ?> >
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <?php
														...
														{
														?>
                  <p class="help-block"><img src="<?=URL?>photos/small/<?php echo $main_img; ?>" width="74" height="93"  />&nbsp;&nbsp;<a href="<?=$add_url?>/?delimg=<?=$main_img_id?>&edit=<?=$id?>&page=<?=$page?>" role="button" onClick="return confirm('Do you want to delete this Image?')"><span class="fas fa-trash-alt"></span></a></p>
                  <?php
														}
														?>
                </div>
              ...
              <div class="col-md-12" style=" padding:10px;">
                <div class="form-group">
                  <label>Sub Images (850 px x 450 px) </label>
                  <br>
                  <input type="file"  name="subimage[]" multiple   /><span>(Ctrl to select multiple images)</span>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div style="border:1px solid #009900; padding:10px;">
                    <div class="form-group">
                      <p class="help-block"><img src="<?=URL?>photos/small/<?php echo $val['image']; ?>" width="74" height="93" />&nbsp;&nbsp;<a href="<?=$add_url?>/?delimg=<?=$val['id']?>&edit=<?=$id?>&page=<?=$page?>" role="button" onClick="return confirm('Do you want to delete this Image?')"><span class="fas fa-trash-alt"></span></a></p>
                    </div>
            ...
            <div class="card-footer center">
              ...
              <a  class="btn btn-warning" type="button"   href="<?=$add_url?>" onClick="res()" name="Reset"><i class="fa fa-undo"></i>&nbsp;Reset </a>
              <?php
						}
						?>
            </div>
...
<script src="<?=URLAD?>plugins/multiselect/jquery.multi-select.js" type="text/javascript"></script>
<script type="text/javascript">
